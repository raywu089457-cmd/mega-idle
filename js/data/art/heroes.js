/* 放置王國 MEGA IDLE — hero art, hand-drawn 16x16 (slice B7 owns).
   ...
   v563 F7 幀段契約：幀 7 = 職業特化攻擊幀（刺客突刺／騎士盾頂）— 僅少數職業有；
   頭/盔列與 F0 逐字元一致（同一角色契約），render.js 揮擊主幀依職業選用（無 F7 者回退幀 2）。
...
L: "#d36b76"
    ...
    framesRows: [
      ...
      // v563 F7 職業特化攻擊幀（突刺）：雙匕首向前刺出 — 頭/面具列 0-8 與 F0 逐字元一致（同一角色契約），
      // 手臂前伸＋匕首（A 黑尖＋KK 刃）指向敵方（翻轉後 sprite-left=畫面右方=怪物側），前腿弓步、後腿蹬地
      [".....AAAAAAAB...", "...ACDEDDDDDFA..", "..BFEDGEDEEDEHB.", "..BFGEEEDDDDGIB.", "..AFGJEEEEEJJIA.", ".BHKICIJJJJCIKLB", ".BIIAGCACCAGFFIB", ".BFIAGCHJIAGFFIB", "..AAACLDDDLCAAA.", "AKKBFIJICCCCLIIH", "AKKAGEDEEDLELHH.", ".BIGGKDJJJJIDLKI", "..BIJGGALEEEECA.", "..BDFFEEAB......", "..BICFJIAB......", ".......ABFEECB.."]
    ]
  },
...
L: "#debe89"
    ...
    framesRows: [
      ...
      // v563 F7 職業特化攻擊幀（盾頂）：盾牌自腰際舉至胸前一推 — 頭盔列 0-4 與 F0 逐字元一致（同一角色契約），
      // 金色鳶盾（L/E）抬升 5 列（盾面覆胸、前推指向敵方）、身體後縮靠盾、雙足踏地
      [".AABCAAAABC.....", "CDEFFDEDDDFBB...", "..GFDEEHADEDGH..", ".CIJGFGKJADFJICB", ".CHJJCGKIHFIJHA.", ".CDFAGJIJJGGDDFC", "CELLEELLLLGFEDC.", "CELKIFLELEFBHAC.", ".AHHAFLALLGFDDC.", ".CFDFHJCIKJFDDC.", "....CDFAGJIJJGGD", ".....ABJIBHHBIJH", ".....BFLIHEEHILF", "....AIIJFELLEFHG", "...CJKKIJHHHHJJJ", "....CBABCBBJIGCA"]
    ]
  },
