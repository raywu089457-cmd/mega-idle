...
MG.data.changelog = [
  {
    v: "v706", title: "比較空→英雄／商城無貨→副本／試煉無編隊→英雄（QoL×3）",
    notes: [
      "① 裝備比較無可用英雄 → 前往英雄",
      "② 商城／市場無貨 → 前往副本",
      "③ 試煉塔無編隊 → 前往英雄"
  ...
  {
    v: "v705", title: "寶石工坊閃點／左花圃蝸牛／祭壇香煙（村莊美術×3）",
    notes: [
      "① 寶石工坊屋頂青藍閃點（建成才畫）",
      "② 左花圃蝸牛慢爬",
      "③ 祭壇淡香煙縷（建成才畫）"
  ...
  {
    v: "v704", title: "遠古科技軟封／公會經驗軟封／訓練經驗後期加深（數值平衡×3）",
    notes: [
      "① 遠古科技 Lv11+：1.6^min(lvl-11,5)（Lv≤16 不變）",
      "② 公會升級經驗：min(lv,18)^1.6（Lv≤18 不變）",
      "③ 訓練經驗 Lv≥100：×1.2 段加深（對齊 trainCost 節奏）"
    ]
  },
  {
  ...
  {
    v: "v701", title: "鐵匠火花／倉庫夜貓頭鷹／晾衣繩松鼠（村莊美術×3）",
    notes: [
      "① 鐵匠屋頂橙黃火花上飄（建成才畫）",
      "② 倉庫夜貓頭鷹（night only・屋脊佇立）",
      "③ 晾衣繩松鼠柱間短竄"
    ]
  },
  {
    v: "v700", title: "公會首領HP軟封／遣散返還軟封／技能書高階加深（數值平衡×3）",
    notes: [
      "① 公會週首領 HP 1.55／1.62^min(lv-1,16)（Lv≤17 不變）",
      "② 遣散返還 1.4^min(level,50)（Lv≤50 不變；spent×1.1 仍為硬頂）",
      "③ 技能升級 lvl≥7 ×1.3^(lvl-6)（≤6 不變）"
    ]
  },
  {
  ...
  {
    v: "v697", title: "右田野兔／黃昏飛蛾／風車鴿子（村莊美術×3）",
    notes: [
      "① 右農田野兔偶發跳",
      "② 黃昏火把飛蛾×3（dusk only）",
      "③ 風車區鴿子×2 緩飛"
  ...
  {
    v: "v696", title: "公會科技軟封／寶石融合階位軟封／神器覺醒加深（數值平衡×3）",
    notes: [
      "① 公會科技 1.65^min(cur,10)（≤10 不變）",
      "② 寶石融合 1.45^min(t-1,8)（t≤9 不變；t≥6 加深保留）",
      "③ 神器覺醒 aw≥1 ×1.2^aw（首覺不變）"
    ]
  },
  {
  ...
  {
    v: "v693", title: "石堆蜥蜴／水井青蛙／稻草人烏鴉（村莊美術×3）",
    notes: [
      "① 石堆蜥蜴晒陽短竄（stone@319）",
      "② 水井青蛙偶發跳（well@181）",
      "③ 稻草人肩烏鴉振翅（scarecrow@48）"
    ]
  },
  {
  ...
  {
    v: "v689", title: "木桶老鼠／乾草飛絮／夜間蝙蝠（村莊美術×3）",
    notes: [
      "① 木桶旁老鼠短竄（rm 定幀）",
      "② 乾草飛絮 ×4（rm 定幀）",
      "③ 夜間蝙蝠剪影 ×3（與螢火蟲分層）"
  ...
  {
    v: "v685", title: "長椅麻雀／農田稻草人／白天屋頂反光（村莊美術×3）",
    notes: [
      "① 廣場長椅麻雀 ×2（跳／佇；rm 定幀）",
      "② 左農田稻草人微晃（rm 定幀）",
      "③ 白天建成建築屋頂反光（與夜窗對稱）"
  ...
  {
    v: "v681", title: "夏蜻蜓／水井波光／花圃蜜蜂（村莊美術×3）",
    notes: [
      "① 夏季蜻蜓剪影 ×3（補齊四季動態）",
      "② 水井波光點（常駐；rm 定幀）",
      "③ 花圃蜜蜂繞飛（常駐；rm 定幀）"
  ...
  {
    v: "v680", title: "市場U／世界首領／秘境軟封頂（數值平衡×3）",
    notes: [
      "① 市場週限 U 1.35^min(kl-1,18)（kl≤19 不變）",
      "② 世界首領金幣同軟封頂",
      "③ 秘境金／經驗同軟封頂（豐饒 mats 不變）"
    ]
  },
  {
  ...
  {
    v: "v677", title: "春花瓣／秋落葉／冬細雪（村莊美術×3）",
    notes: [
      "① 春季粉花瓣飄落 ×5",
      "② 秋季琥珀落葉 ×5",
      "③ 冬季細雪 ×8；夏不畫；rm 定幀"
  ...
  {
    v: "v676", title: "寶箱軟封頂／突破金幣加深／徽章金幣加深（數值平衡×3）",
    notes: [
      "① 每日寶箱金 1.35^min(kl-1,20)（kl≤21 不變）",
      "② 突破金幣 n≥4 ×1.2^(n-3)（1–3 階不變）",
      "③ 傳說徽章升階金 lv≥3 ×1.25^(lv-2)（0–2 階不變）"
    ]
  },
  {
  ...
  {
    v: "v673", title: "銅階風鈴／夜窗暖光／螢火蟲（村莊美術×3）",
    notes: [
      "① 銅階（lvl 3–4）屋檐風鈴微晃",
      "② 夜／黃昏建成建築窗暖光",
      "③ 黃昏／夜螢火蟲×6（rm 定幀）"
  ...
  {
    v: "v672", title: "後期經驗／金幣招募軟升／高階融合費（數值平衡×3）",
    notes: [
      "① 升級經驗 lv≥100 ×1.25^(⌊(lv-100)/20⌋+1)（1–99 不變）",
      "② 金幣招募 n>10 ×1.06^min(n-10,20)（n≤10 不變）",
      "③ 寶石融合 t≥6 ×1.25^(t-5)（1–5 階不變）"
    ]
  },
  {
  ...
  {
    v: "v668", title: "訓練後期／榮譽覺醒價／王國費軟封頂（數值平衡×3）",
    notes: [
      "① 訓練 lv≥100 金幣 ×1.3^(⌊(lv-100)/20⌋+1)（1–99 不變）",
      "② 榮譽商店 ×1.12^min(覺醒層,8)（0 覺醒不變）",
      "③ 回收費／素材兌換 1.35^min(kl-1,18) 軟封頂"
    ]
  },
  {
  ...
  },
  {
    ...
    notes: [
      "① 一鍵領取全部 · N（可領來源數一目了然）",
      "② 一鍵例行 · N（可跑免費例行項數）",
      "③ 鍵盤 1–6 切底欄分頁（輸入中／有 modal 不搶鍵）",
      "順手：更多頁殘留 minHeight:30 改 44"
    ]
  },
  {
    v: "v665", title: "白天時段／銀階掛燈／金階飄旗（村莊美術×3）",
    notes: [
      "① 白天時段色票（牆鐘 6–17：藍天太陽白雲＋綠地遠山）",
      "② 銀階屋檐雙側掛燈微晃（rm 定幀）",
      "③ 金階屋頂雙角飄旗微晃（rm 定幀）",
      "補齊白天候選＋銀/金動態飾件"
    ]
  ...
  {
    v: "v664", title: "首領機制難度縮放／套裝2↔4pc／寶石融合金費（數值平衡×3）",
    notes: [
      "① 首領五機制 ×難度係數（1／1.15／1.35／1.55；護盾持續延長）",
      "② 套裝 2pc 收斂、4pc 加強（例：狼 攻15%→13%、暴10%→12%）",
      "③ 寶石融合金幣費 200×1.45^(階-1)（缺金拒絕）"
    ]
  },
  {
  ...
  },
  {
    ...
    notes: [
      ...
      "② 廣場小貓（灰身蹲坐＋尾擺；rm 定幀）",
      "③ 村民＋回城休息英雄偶發撓頭（確定性時窗；rm 無）"
    ]
  },
  {
    v: "v660", title: "突破後期素材／神話招募／商城券價（數值平衡×3）",
    notes: [
      "① 突破 n≥4 素材 ×1.35^(n-3)（1-3 階不變）— 拉長後期農料",
      "② 神話招募 300×1.06^min(n,25)（首抽仍 300）— 防後期無限刷",
      "③ 商城招募券 80→100、五連 380→470 — 鑽石券 ROI 收斂"
    ]
  },
  {
  ...
  },
  {
    ...
    notes: [
      ...
      "② 副本狀態卡正文顯示「連敗 N/3」與「自動進關已暫停」",
      "③ 賣出素材 ±／數量 chip 與派遣目的地列 minHeight ≥44px",
      "效果：桌機捷徑＋掛機狀態零點擊可讀＋觸控不誤觸（本輪打包 3 項）"
    ]
  },
  {
    v: "v657", title: "村莊市場蔬果攤（村莊美術）",
    notes: [
      "問題：生活感 backlog 攤位子項仍空（雞豬/晾衣/狗已有）",
      "修正：drawTownLife 市場南側程序像素攤（棚＋桌＋蘋果/麵包/瓶微晃；rm 定幀）",
      "效果：回城第一屏多一攤可辨市集，補齊攤位候選"
    ]
  },
  {
    v: "v656", title: "技能研讀後期書本成本加深（數值平衡）",
    notes: [
      "問題：研讀 15×(l+1) 線性合計僅 825 書即可 +10% 技能威力 — 中期約數小時封頂，永久乘區無多日水槽",
      "修正：study≥5 附加 ×1.4^(l-4)；0-4 級成本不變；總書約 2212（×2.7）",
      "效果：後期研讀回到多日節奏，書本持續有消費目標"
    ]
  },
  {
  ...
  },
  {
    ...
    notes: [
      ...
      "修正：drawTownLife 廣場帶程序像素狗（棕身＋耳＋尾擺往返；rm 定幀佇立；零 Math.random）",
      "效果：回城第一屏多一隻可辨寵物，補齊小狗候選"
    ]
  },
  {
    v: "v652", title: "每日特惠金幣價軟封頂 1.15^min(kl-1,18)（數值平衡）",
    notes: [
      "問題：特惠價 1.15^(kl-1) 無封頂 — kl30 沙漏≈1.04h、攻擊靈藥≈1.56h 農場金，日特惠 ROI 崩",
      "修正：priceOf 改 1.15^min(kl-1,18)；kl1 不變；商會折扣仍疊；週限兌換錨不動",
      "效果：kl30 沙漏≈0.22h（舊 1.04h），後期仍想點開每日特惠"
    ]
  },
  {
    v: "v651", title: "聖裁聖光柱特效（戰鬥美術）",
    notes: [
      "問題：聖裁/聖光連擊等 fx_heal 傷害技能僅噴粒子點，讀不出「天降之光」",
      "修正：spawnHolyPillar（金黃外圈＋白芯垂直柱＋基座火花）；僅 fx_heal 傷害技能首拍；rm 跳過",
      "效果：牧師/騎士招牌技能掛機可辨，推進 backlog 聖光柱子項"
    ]
  },
  {
    v: "v650", title: "素材總覽掉落區／建築用途雙向跳轉（QoL）",
    notes: [
      "問題：素材倉庫展開只有靜態來源文案，缺料時不知去哪打、能升哪棟建築",
      "修正：展開列顯示掉落區域鈕（≤2 點擊切副本）與消耗建築鈕（開建築頁）；未解鎖區 toast 拒絕",
      "效果：補完 backlog「素材-需求雙向跳轉」done-when"
    ]
  },
  {
    v: "v649", title: "村莊黃昏時段色票層（村莊美術）",
    notes: [
      "問題：村莊底景永遠同一夜色，回城「家」缺少時段變化；backlog 時段/季節色調未完成",
      "修正：drawTown 新增 dusk/night 兩套天空・星・月・地面色票；牆鐘 17–20 點自動黃昏，其餘夜景；副本城內場景同源",
      "效果：≥2 時段獨立色票，黃昏暖紫橙與夜景可辨，切換無結構閃爍"
    ]
  },
  {
    v: "v648", title: "日課/簽到金幣軟縮放（1.18^min(kl-1,20)）（數值平衡）",
    notes: [
      "問題：日課/簽到金幣 ×1.35^(kl-1) 無封頂 — kl20≈7h、kl30≈135h 農場當量，日課變印鈔主收入擠壓掛機",
      "修正：scaleQuestGold 改 1.18^min(kl-1,20)；週任 1.15；簽到改走同一 helper；鑽石/券零變動",
      "效果：kl1 不變；kl30 日課合計約 0.6h 農場金（舊 135h），後期日課有感但不取代主迴圈"
    ]
  },
  {
  ...
  },
  {
    ...
    notes: [
      ...
      "修正：drawTownLife 於倉庫南側空地繪製晾衣繩（兩木柱＋橫繩＋莓紅/天空藍/薄荷三件衣物確定性微擺）；rm 定幀",
      "效果：村莊多一組 1× 可辨生活元素，推進「更多生活感」晾衣子項"
    ]
  },
  {
    v: "v644", title: "強化 +10 起金幣成本加深（1.35^(enhance-9)）（數值平衡）",
    notes: [
      "問題：中後期裝備 +10→+15 金幣水槽過淺 — r4@52 萬金/h 下 tier5 單件僅 0.76h、單英雄 7 件 5.3h，強化點完金幣無處消耗",
      "修正：enhanceCost 在 enhance≥10 附加 ×1.35^(enhance-9)；e0-9 公式不變；鐵匠折扣仍疊乘",
      "效果：同錨點單件 0.76→2.51h、單英雄 5.3→17.6h，+10 段回到數小時～大半天節奏，早中期強化手感不變"
    ]
  },
  {
