...
MG.data.changelog = [
  {
    v: "v850", title: "建築未解鎖／祭壇未建／訓練場未建空態（QoL×3）",
    notes: [
      "① 建築解鎖未達 → 前往副本",
      "② 昇華祭壇未建 → 前往王國",
      "③ 訓練場未建 → 前往王國"
  ...
  {
    v: "v849", title: "酒館酒桶／煉金研缽／寶石放大鏡（村莊美術×3）",
    notes: [
      "① 酒館酒桶（簷側褐桶＋泡沫）",
      "② 煉金研缽（簷前石缽＋杵）",
      "③ 寶石放大鏡（簷前銅圈＋柄）"
  ...
  {
    v: "v845", title: "圖書館講台／訓練木人樁／市場天平（村莊美術×3）",
    notes: [
      "① 圖書館講台（簷側木台＋開書）",
      "② 訓練木人樁（場側褐樁＋草繩）",
      "③ 市場天平（簷前銅臂＋盤）"
  ...
  {
    v: "v841", title: "鐵匠風箱／倉庫木桶／祭壇供碗（村莊美術×3）",
    notes: [
      "① 鐵匠風箱（簷側褐箱＋皮）",
      "② 倉庫木桶（簷前褐桶＋鐵箍）",
      "③ 祭壇供碗（簷前銅碗＋果）"
  ...
  {
    v: "v837", title: "圖書館墨水／酒館酒杯／寶石鑿刀（村莊美術×3）",
    notes: [
      "① 圖書館墨水瓶",
      "② 酒館酒杯",
      "③ 寶石鑿刀"
  ...
  {
    v: "v833", title: "市場燈籠／城堡水井／訓練盾架（村莊美術×3）",
    notes: [
      "① 市場燈籠",
      "② 城堡水井",
      "③ 訓練盾架"
  ...
  {
    v: "v829", title: "鐵匠錘架／倉庫木箱／祭壇香爐（村莊美術×3）",
    notes: [
      "① 鐵匠錘架",
      "② 倉庫木箱",
      "③ 祭壇香爐"
  ...
  {
    v: "v828", title: "公會經驗／科技／寶石融合基指數軟封（數值平衡×3）",
    notes: [
      "① 公會經驗 soft-cap 10→8",
      "② 公會科技 soft-cap 2→0",
      "③ 寶石融合基指數 soft-cap 1→0"
    ]
  },
  {
  ...
  {
    v: "v825", title: "酒館木凳／煉金藥架／寶石托座（村莊美術×3）",
    notes: [
      "① 酒館木凳",
      "② 煉金藥架",
      "③ 寶石托座"
  ...
  {
    v: "v824", title: "公會經驗／科技／寶石融合基指數軟封（數值平衡×3）",
    notes: [
      "① 公會經驗 soft-cap 12→10",
      "② 公會科技 soft-cap 4→2",
      "③ 寶石融合基指數 soft-cap 2→1"
    ]
  },
  {
  ...
  {
    v: "v821", title: "市場果籃／圖書館書堆／訓練場矛架（村莊美術×3）",
    notes: [
      "① 市場果籃",
      "② 圖書館書堆",
      "③ 訓練場矛架"
  ...
  {
    v: "v817", title: "倉庫掃帚／鐵匠鉗／祭壇香燭（村莊美術×3）",
    notes: [
      "① 倉庫掃帚",
      "② 鐵匠鉗",
      "③ 祭壇香燭"
  ...
  {
    v: "v816", title: "公會經驗／科技／寶石融合基指數軟封（數值平衡×3）",
    notes: [
      "① 公會經驗 soft-cap 16→14",
      "② 公會科技 soft-cap 8→6",
      "③ 寶石融合基指數 soft-cap 6→4"
    ]
  },
  {
  ...
  {
    v: "v813", title: "煉金研缽／圖書館卷軸／寶石放大鏡（村莊美術×3）",
    notes: [
      "① 煉金坊石缽與杵",
      "② 圖書館米色卷軸",
      "③ 寶石工坊銅圈放大鏡"
  ...
  {
    v: "v812", title: "公會升級／公會科技／寶石融合基指數軟封（數值平衡×3）",
    notes: [
      "① 公會經驗 soft-cap 18→16",
      "② 公會科技 soft-cap 10→8",
      "③ 寶石融合基指數 soft-cap 8→6"
    ]
  },
  {
  ...
  {
    v: "v809", title: "王城門旗／訓練木劍／市場天秤（村莊美術×3）",
    notes: [
      "① 王城門側藍旗金桿",
      "② 訓練場木劍",
      "③ 市場銅盤天秤"
  ...
  {
    v: "v797", title: "市場木箱／王城門匾／訓練場圓盾（村莊美術×3）",
    notes: [
      "① 市場木箱",
      "② 王城門匾",
      "③ 訓練場圓盾"
  ...
  {
    v: "v796", title: "升級經驗／神器覺醒／技能研讀 deepen 軟封（數值平衡×3）",
    notes: [
      "① 升級經驗：1.25^min(seg,1)（lv≤119 不變）",
      "② 神器覺醒：1.2^min(aw,0)（aw≤0 不變・二／三覺平坦）",
      "③ 技能研讀：1.4^min(l-4,0)（l≤4 不變・高階平坦）"
    ]
  },
  {
  ...
  {
    v: "v793", title: "祭壇銅鈴／酒館陶杯／寶石托盤（村莊美術×3）",
    notes: [
      "① 祭壇銅鈴",
      "② 酒館陶杯",
      "③ 寶石托盤"
  ...
  {
    v: "v792", title: "金幣招募／升級經驗／榮譽印記 deepen 軟封（數值平衡×3）",
    notes: [
      "① 金幣招募：1.06^min(n-10,0)（n≤10 不變・後期平坦）",
      "② 升級經驗：1.25^min(seg,2)（lv≤139 不變）",
      "③ 榮譽印記：1.12^min(aw,0)（aw≤0 不變・覺醒縮放平坦）"
    ]
  },
  {
  ...
  {
    v: "v789", title: "圖書館捲軸／鐵匠馬蹄鐵／倉庫木桶（村莊美術×3）",
    notes: [
      "① 圖書館捲軸",
      "② 鐵匠馬蹄鐵",
      "③ 倉庫木桶"
  ...
  {
    v: "v788", title: "金幣招募／神話招募／升級經驗 deepen 軟封（數值平衡×3）",
    notes: [
      "① 金幣招募：1.06^min(n-10,1)（n≤11 不變）",
      "② 神話招募：1.04^min(n-25,0)（n≤25 不變・第二階梯平坦）",
      "③ 升級經驗：1.25^min(seg,3)（lv≤159 不變）"
    ]
  },
  {
    v: "v787", title: "週限缺金／王者幣不足／印記缺榮譽空態 CTA（QoL×3）",
    notes: [
      "① 市場週限金幣不足 → 前往副本",
      "② 王者商店王者幣不足 → 繼續挑戰",
      "③ 榮譽印記升級榮譽不足 → 前往競技場"
  ...
  {
    v: "v784", title: "金幣招募／神話招募／技能書升級 deepen 軟封（數值平衡×3）",
    notes: [
      "① 金幣招募：1.06^min(n-10,2)（n≤12 不變）",
      "② 神話招募：1.04^min(n-25,1)（n≤26 不變）",
      "③ 技能升級：1.3^min(lvl-6,0)（lvl≤6 不變・高階平坦）"
    ]
  },
  {
    v: "v783", title: "榮譽不足／特惠缺金／昇華未達空態 CTA（QoL×3）",
    notes: [
      "① 榮譽商店榮譽不足 → 前往競技場",
      "② 每日特惠金幣不足 → 前往副本",
      "③ 昇華條件未達 → 前往副本"
  ...
  {
    v: "v780", title: "金幣招募／神話招募／遠古科技 deepen 軟封（數值平衡×3）",
    notes: [
      "① 金幣招募：1.06^min(n-10,4)（n≤14 不變）",
      "② 神話招募：1.04^min(n-25,2)（n≤27 不變）",
      "③ 遠古科技：1.6^min(lvl-11,0)（Lv≤11 不變・第二階梯平坦）"
    ]
  },
  {
    v: "v779", title: "金幣招募冷卻／裝備缺料／商城缺鑽空態 CTA（QoL×3）",
    notes: [
      "① 金幣招募冷卻中 → 前往任務",
      "② 裝備打造缺金／缺料 → 前往副本",
      "③ 商城鑽石不足（課金裝備）→ 前往簽到"
  ...
  {
    v: "v776", title: "金幣招募／神話招募／訓練經驗 deepen 軟封（數值平衡×3）",
    notes: [
      "① 金幣招募：1.06^min(n-10,6)（n≤16 不變）",
      "② 神話招募：1.04^min(n-25,3)（n≤28 不變）",
      "③ 訓練經驗：1.2^min(seg,1)（lv≤119 不變）"
    ]
  },
  {
    v: "v775", title: "缺鑽／缺金／缺更名券空態 CTA（QoL×3）",
    notes: [
      "① 神話招募缺鑽 → 前往簽到",
      "② 金幣招募缺金 → 前往副本",
      "③ 更名缺券 → 前往商城"
  ...
  {
    v: "v772", title: "遠古科技／神話招募／訓練經驗 deepen 軟封（數值平衡×3）",
    notes: [
      "① 遠古科技：1.6^min(lvl-11,1)（Lv≤12 不變）",
      "② 神話招募：1.04^min(n-25,4)（n≤29 不變）",
      "③ 訓練經驗：1.2^min(seg,2)（lv≤139 不變）"
    ]
  },
  {
    v: "v771", title: "道具缺料／缺券／缺書空態 CTA（QoL×3）",
    notes: [
      "① 鐵匠道具全不可製 → 前往副本",
      "② 招募券不足 → 前往任務",
      "③ 研讀缺技能書 → 前往副本"
  ...
  {
    v: "v768", title: "遠古科技／神話招募／訓練經驗 deepen 軟封（數值平衡×3）",
    notes: [
      "① 遠古科技：1.6^min(lvl-11,2)（Lv≤13 不變）",
      "② 神話招募：1.04^min(n-25,5)（n≤30 不變）",
      "③ 訓練經驗：1.2^min(seg,3)（lv≤159 不變）"
    ]
  },
  {
    v: "v767", title: "背包滿／神器全擁／寶石不可融空態 CTA（QoL×3）",
    notes: [
      "① 鐵匠製作背包滿 → 前往裝備",
      "② 商城限購全擁有 → 前往副本",
      "③ 寶石皆不足 3 → 前往副本"
  ...
  {
    v: "v764", title: "遠古科技／榮譽印記／金幣招募 deepen 軟封（數值平衡×3）",
    notes: [
      "① 遠古科技：1.6^min(lvl-11,3)（Lv≤14 不變）",
      "② 榮譽升級：1.12^min(aw,1)（aw≤1 不變）",
      "③ 金幣招募：1.06^min(n-10,8)（n≤18 不變）"
    ]
  },
  {
    v: "v763", title: "共鳴槽滿／名冊滿／合成週額空態 CTA（QoL×3）",
    notes: [
      "① 共鳴槽已滿 → 前往副本",
      "② 名冊已滿 → 前往英雄",
      "③ 碎片合成週額用盡 → 前往副本"
  ...
  {
    v: "v760", title: "公會捐獻／遠古科技／神話招募 deepen 軟封（數值平衡×3）",
    notes: [
      "① 公會日捐：1.4^min(lv-1,1)（Lv≤2 不變）",
      "② 遠古科技：1.6^min(lvl-11,4)（Lv≤15 不變）",
      "③ 神話招募：1.04^min(n-25,6)（n≤31 不變）"
    ]
  },
  {
  ...
  {
    v: "v756", title: "公會捐獻／金幣招募／榮譽印記 deepen 軟封（數值平衡×3）",
    notes: [
      "① 公會日捐：1.4^min(lv-1,2)（Lv≤3 不變）",
      "② 金幣招募：1.06^min(n-10,10)（n≤20 不變）",
      "③ 榮譽升級：1.12^min(aw,2)（aw≤2 不變）"
    ]
  },
  {
    v: "v755", title: "公會滿級／王者分檔／素材兌換空態 CTA（QoL×3）",
    notes: [
      "① 公會滿級 → 前往副本",
      "② 王者最高分檔 → 前往副本",
      "③ 深淵素材兌換週額用完 → 前往副本"
  ...
  {
    v: "v748", title: "精煉／徽章／強化 deepen 軟封（數值平衡×3）",
    notes: [
      "① 神器精煉：1.2^min(lv-4,2)（lv≤6 不變）",
      "② 徽章金幣：1.25^min(lv-2,1)（lv≤3 不變）",
      "③ 強化：1.35^min(e-9,1)（e≤10 不變）"
    ]
  },
  {
    v: "v747", title: "週討伐／總傷里程碑／公會科技空態 CTA（QoL×3）",
    notes: [
      "① 世界首領週討伐里程碑全領 → 前往副本",
      "② 世界首領總傷里程碑全領 → 前往副本",
      "③ 公會科技全滿 → 前往副本"
  ...
  {
    v: "v744", title: "研讀／訓練金／公會捐獻 deepen 軟封（數值平衡×3）",
    notes: [
      "① 研讀：1.4^min(l-4,1)（l≤5 不變）",
      "② 訓練金：1.3^min(seg,2)（lv≤139 不變）",
      "③ 公會日捐：1.4^min(lv-1,4)（Lv≤5 不變）"
    ]
  },
  {
  ...
  {
    v: "v740", title: "強化／寶石融合／榮譽 deepen 軟封（數值平衡×3）",
    notes: [
      "① 強化 e≥10：1.35^min(e-9,2)（e≤11 不變）",
      "② 寶石融合 t≥6：1.25^min(t-5,1)（t≤6 不變）",
      "③ 榮譽升級：1.12^min(aw,3)（aw≤3 不變）"
    ]
  },
  {
  ...
  {
    v: "v729", title: "倉庫木箱／祭壇花束／鐵匠砧（村莊美術×3）",
    notes: [
      "① 倉庫簷前木箱堆",
      "② 祭壇台側粉瓣花束",
      "③ 鐵匠場前鐵灰砧座"
  ...
  {
    v: "v728", title: "強化／研讀／寶石融合 deepen 軟封（數值平衡×3）",
    notes: [
      "① 強化 e≥10：1.35^min(e-9,3)（e≤12 不變）",
      "② 研讀 l≥5：1.4^min(l-4,3)（l≤7 不變）",
      "③ 寶石融合 t≥6：1.25^min(t-5,2)（t≤7 不變）"
    ]
  },
  {
  ...
  {
    v: "v725", title: "圖書館攤開書／煉金藥瓶／酒館酒杯（村莊美術×3）",
    notes: [
      "① 圖書館簷前攤開書（米頁＋褐皮）",
      "② 煉金坊簷前藥瓶（綠瓶＋微泡）",
      "③ 酒館門前酒杯（褐杯＋白沫晃）"
  ...
  {
    v: "v724", title: "金幣招募／榮譽覺醒／公會捐獻 deepen 軟封（數值平衡×3）",
    notes: [
      "① 金幣招募 n>10：1.06^min(n-10,12)（n≤22 不變）",
      "② 榮譽升級：1.12^min(aw,4)（aw≤4 不變）",
      "③ 公會捐獻：1.4^min(lv-1,8)（Lv≤9 不變）"
    ]
  },
  {
  ...
  {
    v: "v721", title: "訓練木人／市場果籃／寶石晶錐（村莊美術×3）",
    notes: [
      "① 訓練場木人樁（棕樁＋草頭＋擊閃）",
      "② 市場果籃（編籃＋紅果微晃）",
      "③ 寶石工坊晶錐（青晶脈動）"
  ...
  {
    v: "v720", title: "訓練經驗／神器覺醒／神話招募 deepen 軟封（數值平衡×3）",
    notes: [
      "① 訓練經驗 lv≥100：1.2^min(seg,4)（對齊訓練金）",
      "② 神器覺醒 aw≥1：1.2^min(aw,1)（aw≤1 不變）",
      "③ 神話招募 n>25：1.04^min(n-25,8)（n≤33 不變）"
    ]
  },
  {
    v: "v719", title: "施法青環／AOE 紅環／嘲諷紅標（戰鬥美術×3）",
    notes: [
      "① 技能起手英雄側施法青環",
      "② 震怒 AOE 受擊紅橢環",
      "③ 嘲諷技能怪物側紅標！"
  ...
  {
    v: "v718", title: "深淵商店／特惠／秘境空態 CTA（QoL×3）",
    notes: [
      "① 深淵商店全兌完 → 繼續挑戰",
      "② 每日特惠全售罄 → 前往副本",
      "③ 秘境今日用完 → 前往副本"
  ...
  {
    v: "v717", title: "倉庫揚塵／祭壇燭火／鐵匠淬火汽（村莊美術×3）",
    notes: [
      "① 倉庫白天米色揚塵",
      "② 祭壇台前暖橙燭火",
      "③ 鐵匠砧旁淬火白汽"
  ...
  {
    v: "v714", title: "活動／王者／週限售罄 CTA（QoL×3）",
    notes: [
      "① 活動商店全兌完 → 前往副本",
      "② 王者商店全兌完 → 繼續挑戰",
      "③ 市場週限全兌完 → 前往副本"
  ...
  {
    v: "v713", title: "煉金藥泡／酒館熱氣／王城屋脊鴿（村莊美術×3）",
    notes: [
      "① 煉金坊簷前綠紫藥泡",
      "② 酒館門楣乳白熱氣",
      "③ 王城塔頂白鴿佇／振翅"
  ...
  {
    v: "v712", title: "精煉／技能書／融合 deepen 軟封（數值平衡×3）",
    notes: [
      "① 神器精煉 lv≥5：1.2^min(lv-4,4)（lv≤8 不變）",
      "② 技能升級 lvl≥7：1.3^min(lvl-6,2)（lvl≤8 不變）",
      "③ 寶石融合 t≥6：1.25^min(t-5,3)（t≤8 不變）"
    ]
  },
  {
    v: "v711", title: "寶石青菱／藥水玫焰／技能書靛環（戰鬥美術×3）",
    notes: [
      "① 寶石掉落 → 青藍菱焰",
      "② 藥水掉落 → 玫紅菱焰",
      "③ 技能書掉落 → 靛紫雙環＋書線"
  ...
  {
    v: "v710", title: "穿戴不符→英雄／碎片不足→英雄／榮譽售罄→競技場（QoL×3）",
    notes: [
      "① 穿戴選英雄無相符職業 → 前往英雄",
      "② 碎片合成不足 30 → 前往英雄",
      "③ 榮譽商店全售罄 → 前往競技場"
  ...
  {
    v: "v709", title: "圖書館書頁／市場掛燈／訓練場木屑（村莊美術×3）",
    notes: [
      "① 圖書館屋脊米色書頁飄",
      "② 市場簷下暖黃掛燈搖",
      "③ 訓練場前棕木屑揚"
  ...
  {
    v: "v708", title: "強化／研讀／徽章 deepen 軟封（數值平衡×3）",
    notes: [
      "① 強化 e≥10：1.35^min(e-9,4)（e≤13 不變）",
      "② 研讀 l≥5：1.4^min(l-4,4)（l≤8 不變）",
      "③ 徽章 lv≥3：1.25^min(lv-2,3)（lv≤5 不變）"
    ]
  },
  {
    v: "v707", title: "掉落琥珀焰／精英擊殺紫環／藥水薄荷爆（戰鬥美術×3）",
    notes: [
      "① 裝備掉落 → 琥珀六角焰",
      "② 精英擊殺 → 紫雙環＋斜線",
      "③ 啟用藥水 → 薄荷十字爆"
