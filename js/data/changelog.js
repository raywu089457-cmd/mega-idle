...
MG.data.changelog = [
  {
    v: "v276", title: "六職業 4 方向走路動畫（FF6 風格）",
    notes: [
      "全六職業（劍士/弓手/法師/刺客/騎士/牧師）新增 4 方向走路動畫：down/up/left/right × 3 幀走路循環，左右移動改用真實側面幀（不再鏡像正面）",
      "雙幀集架構：走路幀（dirs）僅村莊/世界地圖走路時使用；戰鬥攻擊三相位、名冊頭像、裝備圖示沿用原有動作幀 — 互不干擾",
      "dir 幀一次烘焙快取（無每幀 canvas 配置）；幀超界 clamp 防呆；reducedMotion 定幀；快取版本 275→276"
    ]
  },
  {
