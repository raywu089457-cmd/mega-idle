...
MG.data.quests = (function () {
  ...
  const SHOP = [
    ...
    { id: "s_pot_hp", name: "生命藥水", desc: "立即恢復全隊 50% 生命（狩獵也會掉落，商店僅是便利補充）", icon: "item_pot_hp", price: { gold: 800 }, get: { pot: "hp" }, qty: "x1" },
    { id: "s_pot_mp", name: "魔力藥水", desc: "立即恢復全隊 50% 魔力（狩獵也會掉落，商店僅是便利補充）", icon: "item_pot_mp", price: { gold: 800 }, get: { pot: "mp" }, qty: "x1" },
