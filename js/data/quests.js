...
MG.data.quests = (function () {
  ...
  const MAIN = [
    ...
    { id: "m8", name: "森林英雄", req: { type: "kill", target: 200 }, reward: { gold: 4000, gems: 30 } },
    ...
    { id: "m19", name: "套裝英雄", req: { type: "set", target: 4 }, reward: { gold: 80000, gems: 80, ticket: 1 } },
  ...
  const ACH = [
    ...
    { id: "a_r1", name: "招募新人", desc: "累計招募 10 名英雄", req: { type: "recruit", target: 10 }, reward: { gems: 30 } },
    { id: "a_r2", name: "公會興旺", desc: "累計招募 50 名英雄", req: { type: "recruit", target: 50 }, reward: { gems: 100, ticket: 2 } },
    ...
    { id: "a_p1", name: "第一次突破", desc: "進行 1 次英雄突破", req: { type: "promote", target: 1 }, reward: { gems: 30 } },
    { id: "a_p2", name: "百煉成鋼", desc: "進行 20 次英雄突破", req: { type: "promote", target: 20 }, reward: { gems: 100 } },
    { id: "a_l1", name: "等級 25", desc: "任一英雄達到 25 級", req: { type: "hunterlvl", target: 25 }, reward: { gems: 40 } },
    { id: "a_l2", name: "等級 50", desc: "任一英雄達到 50 級", req: { type: "hunterlvl", target: 50 }, reward: { gems: 80 } },
    { id: "a_l3", name: "等級 100", desc: "任一英雄達到 100 級", req: { type: "hunterlvl", target: 100 }, reward: { gems: 200, ticket: 2 } },
    ...
    { id: "a_eq3", name: "武裝齊備", desc: "英雄全隊同時裝備 10 件裝備", req: { type: "equip", target: 10 }, reward: { gems: 40 } },
  ...
  const SHOP = [
    ...
    { id: "s_pot_exp", name: "智慧靈藥", desc: "英雄經驗 +50%，持續 30 分鐘", icon: "item_pot_exp", price: { gems: 30 }, get: { pot: "exp" }, qty: "x1" },
