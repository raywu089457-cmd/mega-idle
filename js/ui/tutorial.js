...
MG.ui.tutorial = (function () {
  const STEPS = [
    { icon: "icon_castle", title: "歡迎來到梅根王國", text: "你繼承了祖父的舊王國。這裡的獵人公會將再次偉大——而這一切都從狩獵開始。" },
    { icon: "icon_sword", title: "前往狩獵場", text: "點擊下方「狩獵」分頁。獵人會自動戰鬥、自動獲得金幣與裝備，即使關掉遊戲也會持續成長。" },
    { icon: "icon_recruit", title: "招募獵人", text: "點擊「招募獵人」開啟招募，再點「招募券」分頁，用你的第一張招募券迎接夥伴！稀有度越高，成長越強！" },
    { icon: "icon_hammer", title: "建設王國", text: "升級建築壯大王國：獵人公會增加出戰人數、鐵匠鋪解鎖強化、訓練場加速升級。先把鐵匠鋪蓋起來吧！" },
    { icon: "icon_armor", title: "武裝獵人", text: "狩獵會掉落裝備。點擊背包中的裝備，再按下「強化」（需先建造鐵匠鋪），讓獵人戰力突飛猛進。" },
    { icon: "icon_offline", title: "離線也有收穫", text: "關閉遊戲後，王國會自動狩獵並累積「離線獎勵」。記得回來領取！現在，出發吧，獵人王。" }
  ];
  const TABS = ["kingdom", "hunt", "hunters", "kingdom", "equipment", "hunt"];
