    ...
    for (const e of evs) {
      ...
      switch (e.type) {
        ...
        case "skill": {
          ...
          if (sk.type === "hit" && !sk.heal) spawnStrikeMark(310, 188); // v803：攻擊技青折標
