  ...
  function drawBattle(ctx, view) {
    ...
    if (!rm) {
      for (const p of view.particles || []) {
        ...
        if (p.kind === "gemmark") { // v778 寶石青菱標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 24) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#4da3ff";
          ctx.lineWidth = 2.3;
          ctx.beginPath();
          ctx.moveTo(cx, cy - r * 0.7);
          ...
          ctx.stroke();
          ctx.globalAlpha = a * 0.5;
          ctx.strokeStyle = p.color2 || "#a8d4ff";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
        ...
        if (p.kind === "potmark") { // v778 藥水玫瓶標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 24) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#e85a8a";
          ctx.lineWidth = 2.3;
          ctx.beginPath();
        ...
        if (p.kind === "honormark") { // v778 榮譽琥珀標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 7) + ((p.r1 || 26) - (p.r0 || 7)) * (1 - a);
          ctx.save();
        ...
        if (p.kind === "expmark") { // v786 經驗綠葉標
          ...
          ctx.stroke();
          ctx.globalAlpha = a * 0.5;
          ctx.strokeStyle = p.color2 || "#c8f0c8";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ctx.arc(cx, cy + r * 0.1, Math.max(1, r * 0.2), 0, Math.PI * 2);
          ctx.stroke();
          ctx.restore();
          continue;
        }
        if (p.kind === "regenmark") { // v786 再生綠脈標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 7) + ((p.r1 || 26) - (p.r0 || 7)) * (1 - a);
          ctx.save();
          ...
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#a8e878";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
        ...
        if (p.kind === "stealmark") { // v786 吸血紅心標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 7) + ((p.r1 || 26) - (p.r0 || 7)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#ff7a7a";
          ctx.lineWidth = 2.3;
          ctx.beginPath();
          ctx.moveTo(cx, cy + r * 0.45);
          ctx.bezierCurveTo(cx + r * 0.55, cy + r * 0.05, cx + r * 0.45, cy - r * 0.4, cx, cy - r * 0.1);
          ctx.bezierCurveTo(cx - r * 0.45, cy - r * 0.4, cx - r * 0.55, cy + r * 0.05, cx, cy + r * 0.45);
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#ffb0b0";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ctx.arc(cx - r * 0.1, cy - r * 0.05, Math.max(1, r * 0.12), 0, Math.PI * 2);
          ctx.stroke();
          ctx.restore();
          continue;
        }
        if (p.kind === "elmark") { // v791 克制青菱標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
        ...
        if (p.kind === "wardmark") { // v791 護盾期青盾標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 7) + ((p.r1 || 24) - (p.r0 || 7)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#8ec8ff";
          ctx.lineWidth = 2.3;
          ctx.beginPath();
          ctx.moveTo(cx - r * 0.4, cy - r * 0.35);
          ctx.lineTo(cx + r * 0.4, cy - r * 0.35);
          ctx.lineTo(cx + r * 0.4, cy + r * 0.1);
          ctx.quadraticCurveTo(cx, cy + r * 0.55, cx - r * 0.4, cy + r * 0.1);
          ctx.closePath();
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#d8ecff";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ctx.moveTo(cx, cy - r * 0.2);
          ctx.lineTo(cx, cy + r * 0.2);
        ...
        if (p.kind === "painmark") { // v791 普受擊紅斜標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ...
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ctx.arc(cx, cy, Math.max(1, r * 0.18), 0, Math.PI * 2);
          ctx.stroke();
          ctx.restore();
          continue;
        }
        if (p.kind === "castmark") { // v795 施法靛星標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#9ad0ff";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          ctx.moveTo(cx, cy - r * 0.55);
          ctx.lineTo(cx, cy + r * 0.55);
        ...
        if (p.kind === "entermark") { // v795 登場紫門標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 7) + ((p.r1 || 24) - (p.r0 || 7)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#b48cff";
          ctx.lineWidth = 2.3;
          ctx.beginPath();
          ctx.moveTo(cx - r * 0.35, cy + r * 0.45);
          ctx.lineTo(cx - r * 0.35, cy - r * 0.25);
        ...
        if (p.kind === "strikemark") { // v803 攻擊技青折標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
        ...
        if (p.kind === "vialmark") { // v803 生命藥水玫心標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#ff7ab8";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          ctx.moveTo(cx, cy + r * 0.45);
          ctx.lineTo(cx - r * 0.4, cy);
          ...
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#ffd0e8";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ctx.arc(cx, cy, Math.max(1, r * 0.18), 0, Math.PI * 2);
          ctx.stroke();
        ...
        if (p.kind === "manamark") { // v803 魔力藥水藍滴標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
        ...
        if (p.kind === "rallymark") { // v807 增益金旗標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
        ...
        if (p.kind === "goadmark") { // v807 嘲諷紅角標
          ...
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ctx.arc(cx, cy + r * 0.15, Math.max(1, r * 0.18), 0, Math.PI * 2);
          ctx.stroke();
          ctx.restore();
          continue;
        }
        if (p.kind === "flurrymark") { // v807 連擊橘嵐標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
        ...
        if (p.kind === "slammark") { // v811 普攻銀撞標
          ...
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#f0f4ff";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ctx.arc(cx, cy, Math.max(1, r * 0.18), 0, Math.PI * 2);
          ctx.stroke();
        ...
        if (p.kind === "gleammark") { // v811 暴擊金芒標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ...
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#fff6c8";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ctx.arc(cx, cy, Math.max(1, r * 0.14), 0, Math.PI * 2);
          ctx.stroke();
          ctx.restore();
          continue;
        }
        if (p.kind === "vanquishmark") { // v811 擊殺銀刃標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#b8c4d8";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          ctx.moveTo(cx - r * 0.4, cy + r * 0.35);
          ctx.lineTo(cx + r * 0.15, cy - r * 0.45);
        ...
        if (p.kind === "cleavemark") { // v815 斬擊銀弧標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ...
          ctx.lineWidth = 2.3;
          ctx.beginPath();
          ctx.arc(cx, cy + r * 0.1, Math.max(2, r * 0.55), Math.PI * 1.1, Math.PI * 1.9);
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#f0f4ff";
          ctx.lineWidth = 1.2;
        ...
        if (p.kind === "piercemark") { // v815 箭矢金刺標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
        ...
        if (p.kind === "aegismark") { // v815 護盾藍穹標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ...
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          ctx.arc(cx, cy + r * 0.15, Math.max(2, r * 0.5), Math.PI * 1.05, Math.PI * 1.95);
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#c8e8ff";
          ctx.lineWidth = 1.2;
        ...
        if (p.kind === "frostmark") { // v819 冰系青霜標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
        ...
        if (p.kind === "embermark") { // v819 火球橙燼標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#ff8a3a";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          ctx.moveTo(cx, cy - r * 0.5);
        ...
        if (p.kind === "plaguemark") { // v823 淬毒紫疫標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#b86ad8";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          for (let i = 0; i < 6; i++) {
            const ang = (i / 6) * Math.PI * 2 - Math.PI / 2;
        ...
        if (p.kind === "blessmark") { // v823 聖光白佑標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#e8e0c8";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          ctx.moveTo(cx, cy - r * 0.5);
          ctx.lineTo(cx, cy + r * 0.5);
          ...
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#fff8e8";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
          ctx.arc(cx, cy - r * 0.05, Math.max(1, r * 0.22), 0, Math.PI * 2);
          ctx.stroke();
          ctx.restore();
          continue;
        }
        ...
        if (p.kind === "crushmark") { // v831 重擊橙壓標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#ff9c4a";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          ctx.moveTo(cx - r * 0.45, cy - r * 0.35);
          ctx.lineTo(cx + r * 0.45, cy - r * 0.35);
        ...
        if (p.kind === "blitzmark") { // v831 高連擊青閃標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#5ec8e5";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
        ...
        if (p.kind === "scorchmark") { // v831 灼燒赤焰標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#ff6a3a";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          ctx.moveTo(cx, cy + r * 0.45);
          ctx.quadraticCurveTo(cx + r * 0.35, cy, cx, cy - r * 0.5);
          ctx.quadraticCurveTo(cx - r * 0.35, cy, cx, cy + r * 0.45);
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#ffc8a0";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
        ...
        if (p.kind === "baitmark") { // v839 嘲諷紅餌標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
          ctx.globalAlpha = a * 0.95;
          ctx.strokeStyle = p.color || "#e05c5c";
          ctx.lineWidth = 2.2;
          ctx.beginPath();
          ctx.moveTo(cx, cy - r * 0.45);
          ctx.lineTo(cx + r * 0.35, cy + r * 0.25);
          ...
          ctx.stroke();
          ctx.globalAlpha = a * 0.45;
          ctx.strokeStyle = p.color2 || "#ffc0c0";
          ctx.lineWidth = 1.2;
          ctx.beginPath();
        ...
        if (p.kind === "swarmmark") { // v839 連擊橘群標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
        ...
        if (p.kind === "crestmark") { // v839 增益金徽標
          const a = Math.max(0, p.life / p.maxLife);
          const cx = p.cx || 0, cy = p.cy || 0;
          const r = (p.r0 || 6) + ((p.r1 || 22) - (p.r0 || 6)) * (1 - a);
          ctx.save();
