...
MG.ui.more = (function () {
  ...
  function openCheckin() {
    ...
    // v334：月進度條
    m.panel.appendChild(MG.ui.dom.h("div", { class: "pbar", style: { height: 5, margin: "4px 14px 0" }, title: "每日簽到：每月 30 天（午夜重置）— 漏簽不補但可跨月重新開始" }, MG.ui.dom.h("i", { style: { width: Math.min(100, Math.round(day / 30 * 100)) + "%" } })));
