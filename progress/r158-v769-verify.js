/* v769 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-158-v769";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=769", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    // 藥瓶綠／紫
    const flask = countColor(96, 142, 114, 158, (r, g, b) =>
      (g > r && g > 90 && b < 140) || (b > r && b > 140 && g < 200));
    // 旗藍／金
    const flag = countColor(66, 82, 84, 104, (r, g, b) =>
      (b > r && b > 100 && g < 160) || (r > 180 && g > 160 && b < 140));
    // 木凳褐
    const stool = countColor(356, 148, 374, 162, (r, g, b) =>
      r > 90 && g > 50 && b < 90 && r > b);

    st.settings.reducedMotion = true;
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h1a = hashRoi(96, 142, 114, 158);
    const h1b = hashRoi(66, 82, 84, 104);
    const h1c = hashRoi(356, 148, 374, 162);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(96, 142, 114, 158);
    const h2b = hashRoi(66, 82, 84, 104);
    const h2c = hashRoi(356, 148, 374, 162);
  ...
  assert("srcFlask", k.includes("v769 煉金藥瓶架"));
  assert("srcFlag", k.includes("v769 王城豎旗"));
  assert("srcStool", k.includes("v769 市場木凳"));
  assert("flaskROI", r.flask >= 6);
  assert("flagROI", r.flag >= 6);
  assert("stoolROI", r.stool >= 8);
  ...
  const table = [
    "=== 村莊美術驗證 ===",
    "flask=" + r.flask + " flag=" + r.flag + " stool=" + r.stool + " rmSame=" + r.rmSame,
