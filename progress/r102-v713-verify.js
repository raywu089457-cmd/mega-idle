/* v713 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-102-v713";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=713", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    // 綠紫藥泡
    const bubbles = countColor(70, 90, 100, 120, (r, g, b) =>
      (g > 180 && r < 160 && b < 180) || (r > 160 && b > 180 && g < 180));
    // 乳白熱氣
    const steam = countColor(135, 55, 165, 85, (r, g, b) =>
      r > 200 && g > 200 && b > 210 && Math.abs(r - g) < 25 && Math.abs(g - b) < 30);
    // 白鴿＋橙嘴
    const dove = countColor(65, 40, 90, 58, (r, g, b) =>
      (r > 220 && g > 220 && b > 220) || (r > 200 && g > 120 && b < 100));
    ...
    return { bubbles, steam, dove, rmSame: h1 === h2, h1, h2 };
  });
  ...
  assert("srcBubbles", k.includes("v713 煉金坊藥泡"));
  assert("srcSteam", k.includes("v713 酒館熱氣"));
  assert("srcDove", k.includes("v713 王城屋脊鴿"));
  assert("bubblesROI", r.bubbles >= 2);
  assert("steamROI", r.steam >= 2);
  assert("doveROI", r.dove >= 4);
  ...
  const table = [
    "=== 村莊美術驗證 ===",
    "bubbles=" + r.bubbles + " steam=" + r.steam + " dove=" + r.dove + " rmSame=" + r.rmSame,
