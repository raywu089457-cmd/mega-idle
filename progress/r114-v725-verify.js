/* v725 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-114-v725";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=725", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    // 米頁書
    const book = countColor(148, 140, 175, 160, (r, g, b) =>
      r > 180 && g > 170 && b > 140 && b < 210 && Math.abs(r - g) < 40 && r >= g && g >= b);
    // 綠藥瓶
    const vial = countColor(75, 140, 95, 160, (r, g, b) =>
      g > 100 && g > r && g > b && r < 140 && b < 140);
    // 酒杯褐／沫
    const mug = countColor(140, 88, 165, 112, (r, g, b) =>
      (r > 100 && r < 180 && g > 60 && g < 130 && b < 90 && r > g) ||
      (r > 200 && g > 200 && b > 180 && Math.abs(r - g) < 30));
    ...
    return { book, vial, mug, rmSame: h1 === h2, h1, h2 };
  });
  ...
  assert("srcBook", k.includes("v725 圖書館攤開書"));
  assert("srcVial", k.includes("v725 煉金坊藥瓶"));
  assert("srcMug", k.includes("v725 酒館門前酒杯"));
  assert("bookROI", r.book >= 6);
  assert("vialROI", r.vial >= 4);
  assert("mugROI", r.mug >= 6);
  ...
  const table = [
    "=== 村莊美術驗證 ===",
    "book=" + r.book + " vial=" + r.vial + " mug=" + r.mug + " rmSame=" + r.rmSame,
