/* v793 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-182-v793";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=793", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    const bell = countColor(324, 128, 340, 144, (r, g, b) =>
      (r > 160 && g > 110 && b < 120) || (r > 200 && g > 180 && b > 100));
    const mug = countColor(168, 94, 184, 110, (r, g, b) =>
      (r > 100 && g > 60 && b < 90 && r > b) || (r > 180 && g > 170 && b > 150));
    const tray = countColor(394, 90, 412, 106, (r, g, b) =>
      (b > r && b > 120) || (r > 180 && b > 140 && g < 160) || (r > 100 && g > 60 && b < 90));

    st.settings.reducedMotion = true;
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h1a = hashRoi(324, 128, 340, 144);
    const h1b = hashRoi(168, 94, 184, 110);
    const h1c = hashRoi(394, 90, 412, 106);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(324, 128, 340, 144);
    const h2b = hashRoi(168, 94, 184, 110);
    const h2c = hashRoi(394, 90, 412, 106);

    return { bell, mug, tray, rmSame: h1a === h2a && h1b === h2b && h1c === h2c };
  });
  ...
  const asserts = [
    { name: "srcBell", ok: k.includes("v793 祭壇銅鈴") },
    { name: "srcMug", ok: k.includes("v793 酒館陶杯") },
    { name: "srcTray", ok: k.includes("v793 寶石托盤") },
    { name: "bellROI", ok: r.bell >= 6 },
    { name: "mugROI", ok: r.mug >= 6 },
    { name: "trayROI", ok: r.tray >= 6 },
