/* v845 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-234-v845";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=845", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    // lectern ~190,152
    const lectern = countColor(188, 150, 204, 164, (r, g, b) =>
      (r > 100 && g > 60 && b < 90) || (r > 180 && g > 180 && b > 160) || (b > r && b > 100));
    // dummy ~248,118
    const dummy = countColor(246, 116, 260, 134, (r, g, b) =>
      (r > 100 && g > 60 && b < 90) || (g > r && g > 100 && b < 140));
    // scale ~402,152
    const scale = countColor(400, 150, 416, 164, (r, g, b) =>
      (r > 180 && g > 140 && b < 120) || (r > 160 && g < 120 && b < 120) || (g > r && g > 100 && b < 140));

    st.settings.reducedMotion = true;
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h1a = hashRoi(188, 150, 204, 164);
    const h1b = hashRoi(246, 116, 260, 134);
    const h1c = hashRoi(400, 150, 416, 164);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(188, 150, 204, 164);
    const h2b = hashRoi(246, 116, 260, 134);
    const h2c = hashRoi(400, 150, 416, 164);

    return { lectern, dummy, scale, rmSame: h1a === h2a && h1b === h2b && h1c === h2c };
  });
  ...
  const asserts = [
    { name: "srcLectern", ok: k.includes("v845 圖書館講台") },
    { name: "srcDummy", ok: k.includes("v845 訓練木人樁") },
    { name: "srcScale", ok: k.includes("v845 市場天平") },
    { name: "lecternROI", ok: r.lectern >= 6 },
    { name: "dummyROI", ok: r.dummy >= 6 },
    { name: "scaleROI", ok: r.scale >= 6 },
