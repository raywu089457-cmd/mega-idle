/* v841 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-230-v841";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=841", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    // bellows ~278,122
    const bellows = countColor(276, 120, 292, 134, (r, g, b) =>
      (r > 100 && g > 60 && b < 90) || (r > 180 && g > 180 && b > 160));
    // barrel ~268,148
    const barrel = countColor(266, 146, 280, 162, (r, g, b) =>
      (r > 100 && g > 60 && b < 90) || (r > 90 && g > 90 && b > 100 && Math.abs(r - g) < 40));
    // bowl ~332,136
    const bowl = countColor(330, 134, 346, 148, (r, g, b) =>
    ...
    const h1a = hashRoi(276, 120, 292, 134);
    const h1b = hashRoi(266, 146, 280, 162);
    const h1c = hashRoi(330, 134, 346, 148);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(276, 120, 292, 134);
    const h2b = hashRoi(266, 146, 280, 162);
    const h2c = hashRoi(330, 134, 346, 148);

    return { bellows, barrel, bowl, rmSame: h1a === h2a && h1b === h2b && h1c === h2c };
  });
  ...
  const asserts = [
    { name: "srcBellows", ok: k.includes("v841 鐵匠風箱") },
    { name: "srcBarrel", ok: k.includes("v841 倉庫木桶") },
    { name: "srcBowl", ok: k.includes("v841 祭壇供碗") },
    { name: "bellowsROI", ok: r.bellows >= 6 },
    { name: "barrelROI", ok: r.barrel >= 6 },
    { name: "bowlROI", ok: r.bowl >= 6 },
