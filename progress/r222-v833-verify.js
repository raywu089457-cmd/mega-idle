/* v833 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-222-v833";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=833", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    const lantern = countColor(426, 128, 438, 146, (r, g, b) =>
      (r > 160 && g < 140 && b < 140) || (r > 100 && g > 60 && b < 90));
    const well = countColor(76, 126, 92, 142, (r, g, b) =>
      (r > 90 && g > 90 && b > 100 && Math.abs(r - g) < 40) || (r > 100 && g > 60 && b < 90));
    const shield = countColor(233, 98, 247, 114, (r, g, b) =>
      (b > r && b > 120) || (r > 100 && g > 60 && b < 90));

    st.settings.reducedMotion = true;
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h1a = hashRoi(426, 128, 438, 146);
    const h1b = hashRoi(76, 126, 92, 142);
    const h1c = hashRoi(233, 98, 247, 114);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(426, 128, 438, 146);
    const h2b = hashRoi(76, 126, 92, 142);
    const h2c = hashRoi(233, 98, 247, 114);

    return { lantern, well, shield, rmSame: h1a === h2a && h1b === h2b && h1c === h2c };
  });
  ...
  const asserts = [
    { name: "srcLantern", ok: k.includes("v833 市場燈籠") },
    { name: "srcWell", ok: k.includes("v833 城堡水井") },
    { name: "srcShield", ok: k.includes("v833 訓練盾架") },
    { name: "lanternROI", ok: r.lantern >= 6 },
    { name: "wellROI", ok: r.well >= 6 },
