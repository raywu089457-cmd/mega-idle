/* v777 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-166-v777";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=777", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    const ink = countColor(156, 136, 172, 152, (r, g, b) =>
      (b > r && b > 80 && g < 160) || (r > 90 && g > 50 && b < 100 && r > b) || (r > 160 && g > 140 && b < 180));
    const tongs = countColor(264, 92, 282, 108, (r, g, b) =>
      (r > 150 && g < 140 && b < 120) || (Math.abs(r - g) < 30 && r > 80 && r < 150 && b < 140));
    const censer = countColor(306, 142, 324, 160, (r, g, b) =>
      (r > 120 && g > 80 && b < 100 && r > b) || (Math.abs(r - g) < 25 && r > 150 && b > 150));

    st.settings.reducedMotion = true;
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h1a = hashRoi(156, 136, 172, 152);
    const h1b = hashRoi(264, 92, 282, 108);
    const h1c = hashRoi(306, 142, 324, 160);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(156, 136, 172, 152);
    const h2b = hashRoi(264, 92, 282, 108);
    const h2c = hashRoi(306, 142, 324, 160);

    return { ink, tongs, censer, rmSame: h1a === h2a && h1b === h2b && h1c === h2c };
  });
  ...
  const asserts = [
    { name: "srcInk", ok: k.includes("v777 圖書館書立") },
    { name: "srcTongs", ok: k.includes("v777 鐵匠火鉗") },
    { name: "srcCenser", ok: k.includes("v777 祭壇香爐") },
    { name: "inkROI", ok: r.ink >= 6 },
    { name: "tongsROI", ok: r.tongs >= 6 },
