/* v809 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-198-v809";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=809", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    const flag = countColor(86, 116, 100, 132, (r, g, b) =>
      (b > r && b > 120 && g < 160) || (r > 160 && g > 120 && b < 120));
    const sword = countColor(248, 106, 262, 122, (r, g, b) =>
      (r > 100 && g > 60 && b < 90) || (Math.abs(r - g) < 30 && r > 90 && r < 180));
    const scale = countColor(398, 140, 414, 154, (r, g, b) =>
      (r > 160 && g > 120 && b < 120) || (r > 100 && g > 60 && b < 90));

    st.settings.reducedMotion = true;
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h1a = hashRoi(86, 116, 100, 132);
    const h1b = hashRoi(248, 106, 262, 122);
    const h1c = hashRoi(398, 140, 414, 154);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(86, 116, 100, 132);
    const h2b = hashRoi(248, 106, 262, 122);
    const h2c = hashRoi(398, 140, 414, 154);

    return { flag, sword, scale, rmSame: h1a === h2a && h1b === h2b && h1c === h2c };
  });
  ...
  const asserts = [
    { name: "srcFlag", ok: k.includes("v809 王城門旗") },
    { name: "srcSword", ok: k.includes("v809 訓練場木劍") },
    { name: "srcScale", ok: k.includes("v809 市場天秤") },
    { name: "flagROI", ok: r.flag >= 6 },
