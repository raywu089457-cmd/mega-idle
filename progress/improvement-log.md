...
- [ ] P1 中後期(區 5-10)金幣/素材收入 vs 強化 +10..+15/突破/建築升級/技能研讀成本曲線模擬驗證(v624 完成建築段: damp() Lv13+ ×1.35→×1.20＋指數段封頂 30 級＋線性尾,消除 altar Lv30 單級 33.6 天牆;強化≈免費反向面[全隊 +10→+15 僅 0.8h]與研讀/突破段留後續輪)
...
- 最近 20 輪統計:
- 修正輪比例: 0% (0/20)
- 各軌道完成: 遊戲數值平衡:5 / 戰鬥畫面美術優化:1 / QoL 與 UX:5 / 村莊與王國美術:4 / 戰鬥畫面美術:5 / TheoTown 世界地圖:1
- 最近 5 輪: v638 QoL 與 UX / v637 遊戲數值平衡 / v636 遊戲數值平衡 / v635 戰鬥畫面美術優化 / v634 QoL 與 UX
