...
- [x] P1 中後期(區 5-10)金幣/素材收入 vs 強化 +10..+15/突破/建築升級/技能研讀成本曲線模擬驗證(v624 建築段；v644 強化 +10 起加深 ×1.35^(enhance-9)；v656 研讀 study≥5 ×1.4^(l-4) 總書 825→2208；突破素材段仍候選)
...
- [x] P1 商店藥水/加速券/高級招募券的價格-效果 ROI(v652：每日特惠金幣價 1.15^min(kl-1,18)；鑽石店招募券另軸仍候選)
- [ ] P1 首領五機制在 4 難度下是否被數值堆疊消解為純三圍比拼

### 村莊與王國美術軌道 backlog(新增 · 候選方向)
- [ ] P1 待機動作補完(撓頭等;眨眼 v568/張望 v325 為基底)
- [x] P1 村莊時段/季節色調(晝夜或黃昏色調層)(v649：dusk/night 兩套色票；牆鐘 17–20 黃昏；白天/季節仍候選)
- [x] P1 更多生活感(擺攤/小狗小貓/更多村民/炊煙/晾衣)(炊煙 v320、蝶 v326、旗 v327、動物 v641、晾衣 v645、小狗 v653、攤位 v657)
...
- [x] P1 技能特效質感(火球拖尾 v590；冰霜碎片 v643；雷鏈 v647；聖光柱 v651；斬擊弧 v655；毒雲/箭矢曳光/匕首扇刃 v659)
