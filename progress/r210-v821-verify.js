/* v821 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-210-v821";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=821", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    const basket = countColor(413, 146, 428, 162, (r, g, b) =>
      (r > 160 && g < 120 && b < 120) || (r > 100 && g > 60 && b < 90) || (g > r && g > 100 && b < 140));
    const books = countColor(160, 150, 174, 164, (r, g, b) =>
      (r > 100 && g > 60 && b < 90) || (b > r && b > 100) || (r > 160 && g > 120 && b < 120));
    const spears = countColor(220, 110, 234, 126, (r, g, b) =>
      (Math.abs(r - g) < 30 && r > 90 && r < 180) || (r > 100 && g > 60 && b < 90));

    st.settings.reducedMotion = true;
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h1a = hashRoi(413, 146, 428, 162);
    const h1b = hashRoi(160, 150, 174, 164);
    const h1c = hashRoi(220, 110, 234, 126);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(413, 146, 428, 162);
    const h2b = hashRoi(160, 150, 174, 164);
    const h2c = hashRoi(220, 110, 234, 126);

    return { basket, books, spears, rmSame: h1a === h2a && h1b === h2b && h1c === h2c };
  });
  ...
  const asserts = [
    { name: "srcBasket", ok: k.includes("v821 市場果籃") },
    { name: "srcBooks", ok: k.includes("v821 圖書館書堆") },
    { name: "srcSpears", ok: k.includes("v821 訓練場矛架") },
    { name: "basketROI", ok: r.basket >= 6 },
    { name: "booksROI", ok: r.books >= 6 },
    { name: "spearsROI", ok: r.spears >= 6 },
