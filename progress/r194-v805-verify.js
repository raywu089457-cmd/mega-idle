/* v805 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-194-v805";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=805", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    const keg = countColor(154, 108, 174, 128, (r, g, b) =>
      (r > 100 && g > 60 && b < 90) || (r > 160 && g > 120 && b < 120));
    const hammer = countColor(301, 114, 318, 132, (r, g, b) =>
      (Math.abs(r - g) < 30 && r > 90 && r < 180) || (r > 100 && g > 60 && b < 80));
    const offer = countColor(306, 141, 324, 156, (r, g, b) =>
      (r > 160 && g > 120 && b < 120) || (r > 160 && g < 120 && b < 120));

    st.settings.reducedMotion = true;
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h1a = hashRoi(154, 108, 174, 128);
    const h1b = hashRoi(301, 114, 318, 132);
    const h1c = hashRoi(306, 141, 324, 156);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(154, 108, 174, 128);
    const h2b = hashRoi(301, 114, 318, 132);
    const h2c = hashRoi(306, 141, 324, 156);

    return { keg, hammer, offer, rmSame: h1a === h2a && h1b === h2b && h1c === h2c };
  });
  ...
  const asserts = [
    { name: "srcKeg", ok: k.includes("v805 酒館酒桶") },
    { name: "srcHammer", ok: k.includes("v805 鐵匠鐵錘") },
    { name: "srcOffer", ok: k.includes("v805 祭壇供果") },
    { name: "kegROI", ok: r.keg >= 6 },
    { name: "hammerROI", ok: r.hammer >= 6 },
    { name: "offerROI", ok: r.offer >= 6 },
