/* v813 village-art ×3 verify */
"use strict";
const fs = require("fs");
const path = require("path");
const { chromium } = require("C:/Users/ray/AppData/Roaming/npm/node_modules/playwright");
const OUT = path.join(__dirname);
const TAG = "round-202-v813";
...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=813", { waitUntil: "domcontentloaded" });
  ...
  const r = await page.evaluate(async () => {
    ...
    const mortar = countColor(113, 153, 128, 168, (r, g, b) =>
      (Math.abs(r - g) < 30 && r > 90 && r < 180) || (g > r && g > 100 && b < 140) || (r > 100 && g > 60 && b < 90));
    const scroll = countColor(188, 146, 204, 160, (r, g, b) =>
      (r > 180 && g > 160 && b > 140) || (r > 100 && g > 60 && b < 90) || (b > r && b > 100));
    const loupe = countColor(368, 98, 382, 114, (r, g, b) =>
      (r > 160 && g > 120 && b < 120) || (b > r && b > 120) || (r > 100 && g > 60 && b < 90));

    st.settings.reducedMotion = true;
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h1a = hashRoi(113, 153, 128, 168);
    const h1b = hashRoi(188, 146, 204, 160);
    const h1c = hashRoi(368, 98, 382, 114);
    if (MG.ui.kingdom.raf) MG.ui.kingdom.raf(6000);
    const h2a = hashRoi(113, 153, 128, 168);
    const h2b = hashRoi(188, 146, 204, 160);
    const h2c = hashRoi(368, 98, 382, 114);

    return { mortar, scroll, loupe, rmSame: h1a === h2a && h1b === h2b && h1c === h2c };
  });
  ...
  const asserts = [
    { name: "srcMortar", ok: k.includes("v813 煉金研缽") },
    { name: "srcScroll", ok: k.includes("v813 圖書館卷軸") },
    { name: "srcLoupe", ok: k.includes("v813 寶石工坊放大鏡") },
