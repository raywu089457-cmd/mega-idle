...
(async () => {
  ...
  await page.goto("http://127.0.0.1:8123/index.html?v=832", { waitUntil: "domcontentloaded" });
  ...
  const live = await page.evaluate(() => {
    ...
    st.formation = [];
    st.guild.level = 15;
    const boss15 = MG.sys.guild.bossMaxHp();
    st.guild.level = 20;
    ...
    return {
      e6: MG.sys.guild.expNeed(6),
      e7: MG.sys.guild.expNeed(7),
      e20: MG.sys.guild.expNeed(20),
      boss15, boss20, dRec
    };
  });
  const asserts = [
    { name: "exp6unchanged", ok: expNeed(6, 6) === expNeed(6, 8) && live.e6 === expNeed(6, 6) },
    { name: "exp7cheaper", ok: expNeed(7, 6) < expNeed(7, 8) && live.e7 === expNeed(7, 6) && live.e20 === expNeed(20, 6) },
    { name: "boss15unchanged", ok: bossHp(15, 14) === bossHp(15, 16) && live.boss15 === bossHp(15, 14) },
    { name: "boss20cheaper", ok: bossHp(20, 14) < bossHp(20, 16) && live.boss20 === bossHp(20, 14) },
    { name: "dungCurveCheaper", ok: dungeonCurve(20, 14) < dungeonCurve(20, 16) && live.dRec === dungeonCurve(20, 14) },
    { name: "dung15same", ok: dungeonCurve(15, 14) === dungeonCurve(15, 16) },
