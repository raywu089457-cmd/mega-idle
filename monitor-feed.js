...
const STAGES = [
  { no: 1, name: "取證", role: "flash", model: "opencode-go/mimo-v2.5-pro", desc: "開瀏覽器/模擬,收集候選證據包(不選題)" },
  { no: 2, name: "規劃", role: "K3", model: "kimi-code/k3-256k:high", desc: "讀證據包,決定只做哪一件事並給方案" },
  { no: 3, name: "實作", role: "flash", model: "opencode-go/mimo-v2.5-pro", desc: "依 K3 方案實作/自驗/commit" },
